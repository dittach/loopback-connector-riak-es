...
module.exports = function(conditions){
  ...
  function rowQuery(){
    var rows = (typeof conditions.limit !== 'undefined')?parseInt(conditions.limit, 10):
                    (typeof conditions.where.limit !== 'undefined')?parseInt(conditions.where.limit, 10):max_result_window;
